...
export interface Env {
  ...
  // Cloudflare RealtimeKit (RTK) — MatrixRTC voice/video backend
  CF_ACCOUNT_ID?: string;   // Cloudflare account ID
  CF_API_TOKEN?: string;    // Cloudflare API bearer token (Realtime Admin permission)
  CF_APP_ID?: string;       // RTK App ID
  RTK_PRESET_NAME?: string; // RTK preset name (e.g. "group_call_host")
